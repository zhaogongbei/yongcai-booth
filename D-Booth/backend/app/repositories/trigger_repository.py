...
class TriggerConfigRepository(BaseRepository[TriggerConfig]):
    ...
    async def get_by_event_and_type(self, event_id: UUID, event_type: TriggerType) -> List[TriggerConfig]:
...
class TriggerLogRepository(BaseRepository[TriggerLog]):
    ...
    async def get_by_event_id(self, event_id: UUID, skip: int = 0, limit: int = 100) -> List[TriggerLog]:
    ...
    async def get_by_trigger_id(self, trigger_id: UUID, skip: int = 0, limit: int = 100) -> List[TriggerLog]:
