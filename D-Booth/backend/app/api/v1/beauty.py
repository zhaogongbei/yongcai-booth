...
_BEAUTY_PRESETS = [
    {"name": "原图",   "params": {"smooth": 0,  "whiten": 0,  "thinFace": 0,  "bigEye": 0,  "eyeLight": 0,  "acne": 0,  "nasolabial": 0,  "teethWhiten": 0,  "lipColor": 0}},
    {"name": "自然",   "params": {"smooth": 60, "whiten": 40, "thinFace": 30, "bigEye": 20, "eyeLight": 30, "acne": 20, "nasolabial": 25, "teethWhiten": 30, "lipColor": 15}},
    {"name": "清新",   "params": {"smooth": 55, "whiten": 55, "thinFace": 35, "bigEye": 30, "eyeLight": 40, "acne": 25, "nasolabial": 30, "teethWhiten": 40, "lipColor": 20}},
    {"name": "白皙",   "params": {"smooth": 70, "whiten": 85, "thinFace": 40, "bigEye": 35, "eyeLight": 45, "acne": 30, "nasolabial": 35, "teethWhiten": 50, "lipColor": 10}},
    {"name": "元气",   "params": {"smooth": 50, "whiten": 35, "thinFace": 50, "bigEye": 55, "eyeLight": 60, "acne": 15, "nasolabial": 20, "teethWhiten": 35, "lipColor": 55}},
    {"name": "高级",   "params": {"smooth": 65, "whiten": 30, "thinFace": 45, "bigEye": 25, "eyeLight": 35, "acne": 40, "nasolabial": 45, "teethWhiten": 25, "lipColor": 25}},
    {"name": "胶片",   "params": {"smooth": 45, "whiten": 20, "thinFace": 25, "bigEye": 15, "eyeLight": 20, "acne": 10, "nasolabial": 10, "teethWhiten": 15, "lipColor": 20}},
    {"name": "奶油",   "params": {"smooth": 85, "whiten": 60, "thinFace": 30, "bigEye": 40, "eyeLight": 50, "acne": 35, "nasolabial": 40, "teethWhiten": 45, "lipColor": 35}},
    {"name": "韩系",   "params": {"smooth": 75, "whiten": 70, "thinFace": 65, "bigEye": 60, "eyeLight": 55, "acne": 45, "nasolabial": 50, "teethWhiten": 55, "lipColor": 45}},
    {"name": "日系",   "params": {"smooth": 60, "whiten": 50, "thinFace": 40, "bigEye": 50, "eyeLight": 45, "acne": 30, "nasolabial": 35, "teethWhiten": 40, "lipColor": 50}},
]
...
async def status_check():
    ...
    from app.services.beauty_service import OPENCV_AVAILABLE, MEDIAPIPE_AVAILABLE
    return {
...
async def preview_beauty(
    ...
    params = BeautyParams(
        smooth=smooth, whiten=whiten, thinFace=thinFace, bigEye=bigEye,
        eyeLight=eyeLight, acne=acne, nasolabial=nasolabial,
        teethWhiten=teethWhiten, lipColor=lipColor,
    )
...
async def apply_beauty_async(req: ApplyRequest):
    ...
    try:
        ...
        result = beauty_processor.process_image(
            b"", BeautyParams(), quality=req.quality
        )
