...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "surveys_event_id_fkey", "surveys", "events", ["event_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "survey_responses_event_id_fkey",
        "survey_responses",
        "events",
        ["event_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "survey_responses_session_id_fkey",
        "survey_responses",
        "photo_sessions",
        ["session_id"],
        ["id"],
    ...
    op.drop_constraint(
        "disclaimer_acceptances_event_id_fkey", "disclaimer_acceptances", type_="foreignkey"
    )
    op.drop_constraint(
        "disclaimer_acceptances_session_id_fkey", "disclaimer_acceptances", type_="foreignkey"
    )
    op.create_foreign_key(
        "disclaimer_acceptances_event_id_fkey",
    ...
    op.create_foreign_key(
        "disclaimer_acceptances_session_id_fkey",
        "disclaimer_acceptances",
        "photo_sessions",
        ["session_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "photos_event_id_fkey", "photos", "events", ["event_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        "photos_session_id_fkey",
        "photos",
        "photo_sessions",
        ["session_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "print_jobs_photo_id_fkey", "print_jobs", "photos", ["photo_id"], ["id"], ondelete="CASCADE"
    )

    # Shares - cascade when photo deleted
    op.drop_constraint("shares_photo_id_fkey", "shares", type_="foreignkey")
    op.create_foreign_key(
        "shares_photo_id_fkey", "shares", "photos", ["photo_id"], ["id"], ondelete="CASCADE"
    )

    # AI Tasks - cascade when team deleted
    op.drop_constraint("ai_tasks_team_id_fkey", "ai_tasks", type_="foreignkey")
    op.create_foreign_key(
        "ai_tasks_team_id_fkey", "ai_tasks", "teams", ["team_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "analytics_events_event_id_fkey",
        "analytics_events",
        "events",
        ["event_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "props_team_id_fkey", "props", "teams", ["team_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        "booths_team_id_fkey", "booths", "teams", ["team_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        "booths_current_event_id_fkey",
        "booths",
        "events",
        ["current_event_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint("webhook_logs_webhook_id_fkey", "webhook_logs", type_="foreignkey")
    op.create_foreign_key(
        "webhook_logs_webhook_id_fkey", "webhook_logs", "webhooks", ["webhook_id"], ["id"]
    )
    ...
    op.drop_constraint("trigger_logs_trigger_id_fkey", "trigger_logs", type_="foreignkey")
    op.create_foreign_key(
        "trigger_logs_event_id_fkey", "trigger_logs", "events", ["event_id"], ["id"]
    )
    op.create_foreign_key(
        "trigger_logs_trigger_id_fkey", "trigger_logs", "trigger_configs", ["trigger_id"], ["id"]
    )

    # Trigger Configs
    op.drop_constraint("trigger_configs_event_id_fkey", "trigger_configs", type_="foreignkey")
    op.create_foreign_key(
        "trigger_configs_event_id_fkey", "trigger_configs", "events", ["event_id"], ["id"]
    )
    ...
    op.drop_constraint("booths_team_id_fkey", "booths", type_="foreignkey")
    op.create_foreign_key(
        "booths_current_event_id_fkey", "booths", "events", ["current_event_id"], ["id"]
    )
    ...
    op.drop_constraint("analytics_events_team_id_fkey", "analytics_events", type_="foreignkey")
    op.create_foreign_key(
        "analytics_events_event_id_fkey", "analytics_events", "events", ["event_id"], ["id"]
    )
    op.create_foreign_key(
        "analytics_events_team_id_fkey", "analytics_events", "teams", ["team_id"], ["id"]
    )
    ...
    op.drop_constraint("photos_event_id_fkey", "photos", type_="foreignkey")
    op.create_foreign_key(
        "photos_session_id_fkey", "photos", "photo_sessions", ["session_id"], ["id"]
    )
    ...
    op.drop_constraint("photo_sessions_event_id_fkey", "photo_sessions", type_="foreignkey")
    op.create_foreign_key(
        "photo_sessions_event_id_fkey", "photo_sessions", "events", ["event_id"], ["id"]
    )
    ...
    op.drop_constraint("disclaimers_event_id_fkey", "disclaimers", type_="foreignkey")
    op.create_foreign_key(
        "disclaimers_event_id_fkey", "disclaimers", "events", ["event_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "survey_responses_event_id_fkey", "survey_responses", "events", ["event_id"], ["id"]
    )
    ...
    op.drop_constraint("signatures_session_id_fkey", "signatures", type_="foreignkey")
    op.create_foreign_key(
        "signatures_session_id_fkey", "signatures", "photo_sessions", ["session_id"], ["id"]
    )
    ...
    op.drop_constraint("teams_subscription_id_fkey", "teams", type_="foreignkey")
    op.create_foreign_key(
        "teams_subscription_id_fkey", "teams", "subscriptions", ["subscription_id"], ["id"]
    )
