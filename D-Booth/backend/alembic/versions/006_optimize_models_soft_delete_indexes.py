...
def upgrade() -> None:
    ...
    tables_for_soft_delete = [
        'users', 'teams', 'team_members', 'events', 'templates',
        'photo_sessions', 'photos', 'print_jobs', 'shares',
        'ai_tasks', 'subscriptions', 'props', 'booths',
        'trigger_configs', 'webhooks', 'signatures', 'surveys',
        'survey_responses', 'disclaimers', 'disclaimer_acceptances'
    ]
    ...
    op.create_foreign_key('fk_survey_response_survey_id', 'survey_responses', 'surveys', ['survey_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_unique_constraint('uq_survey_response_event_session', 'survey_responses', ['event_id', 'session_id'])
    ...
    op.create_foreign_key('fk_disclaimer_acceptance_disclaimer_id', 'disclaimer_acceptances', 'disclaimers', ['disclaimer_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_index('ix_disclaimer_acceptance_disclaimer_id', 'disclaimer_acceptances', ['disclaimer_id'])
    op.create_unique_constraint('uq_disclaimer_acceptance_event_session', 'disclaimer_acceptances', ['event_id', 'session_id'])
    ...
    op.create_index('ix_ai_task_team_status_created', 'ai_tasks', ['team_id', 'status', 'created_at'])
    ...
    op.create_index('ix_analytics_event_team_type_created', 'analytics_events', ['team_id', 'event_type', 'created_at'])
